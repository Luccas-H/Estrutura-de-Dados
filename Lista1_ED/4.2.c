...
void imprimeMatriz(matrizTriangular* matriz) {// Imprime a matriz
    printf("Aqui esta a matriz triangular inferior:\n");
...
void triangularInferior(matrizTriangular* matriz, int linhas, int colunas) // coloca a matriz no formato de uma matriz triangular inferior
{
...
int main() {
    ...
    if(linhas == colunas)// Verifica se a matriz é quadrada
    {
        ...
        {
            triangularInferior(matriz, linhas, colunas);
